...
public class SecureAndroid {
    ...
    public SecureAndroid(Context context, int minIteratons) throws CryptoIOHelper.NoAlgorithmAvailableException, NoSuchAlgorithmException, InvalidKeySpecException {
        ...
        try {
            ...
            Log.i("Iterations", String.valueOf(iterations));
        }
...
//        passwordCrypto = new PasswordCrypto(context, iterations);
        ...
        // Check and define the MAC length according to the availability of SHA256/1 on the current platform
        checkMACLength();
    ...
    /**
     * Encrypts the given byte array plaintext and returns the ciphertext as byte array.
     *
     ...
     */
    public byte[] encrypt(Integrity integrity, byte[] plaintext) throws CryptoIOHelper.NoKeyMaterialException, CryptoIOHelper.IntegrityCheckFailedException, GeneralSecurityException,
            CryptoIOHelper.DataNotAvailableException {
        return encrypt(integrity, plaintext, getAutoPassword().toCharArray());
    }

    /**
     * Decrypts the given byte array ciphertext and returns the plaintext as byte array.
     *
     * @param integrity  The integrity mode. Choose SecureAndroid.Integrity.INTEGRITY or NO_INTEGRITY.
     ...
     * @throws CryptoIOHelper.IntegrityCheckFailedException
     */
    public byte[] decrypt(Integrity integrity, byte[] ciphertext) throws CryptoIOHelper.NoKeyMaterialException, GeneralSecurityException, CryptoIOHelper.DataNotAvailableException,
     ...
     * password and returns the ciphertext as a byte array.
     *
     * @param integrity The integrity mode. Choose SecureAndroid.Integrity.INTEGRITY or NO_INTEGRITY.
     ...
     * @throws CryptoIOHelper.DataNotAvailableException
     */
    public byte[] encryptWithPassword(Integrity integrity, byte[] plaintext, char[] password) throws CryptoIOHelper.NoKeyMaterialException, CryptoIOHelper.IntegrityCheckFailedException, GeneralSecurityException,
            CryptoIOHelper.DataNotAvailableException {
     ...
     * password and returns the plaintext as a byte array.
     *
     * @param integrity  The integrity mode. Choose SecureAndroid.Integrity.INTEGRITY or NO_INTEGRITY.
     * @param ciphertext The ciphertext as byte array.
     ...
     * @throws CryptoIOHelper.IntegrityCheckFailedException
     */
    public byte[] decryptWithPassword(Integrity integrity, byte[] ciphertext, char[] password) throws CryptoIOHelper.NoKeyMaterialException, CryptoIOHelper.DataNotAvailableException, GeneralSecurityException,
            CryptoIOHelper.IntegrityCheckFailedException {
     ...
     */
    public void encryptAndStore(Integrity integrity, Mode mode, byte[] plaintext, String alias) throws CryptoIOHelper.NoKeyMaterialException, CryptoIOHelper.IntegrityCheckFailedException, IOException, GeneralSecurityException,
            CryptoIOHelper.DataNotAvailableException {
        switch (integrity) {
            case INTEGRITY:
     ...
     * @throws CryptoIOHelper.NoKeyMaterialException
     */
    public void encryptAndStoreWithPassword(Integrity integrity, Mode mode, byte[] plaintext, String alias, char[] password) throws CryptoIOHelper.NoKeyMaterialException, CryptoIOHelper.IntegrityCheckFailedException, IOException, GeneralSecurityException,
            CryptoIOHelper.DataNotAvailableException {
        switch (integrity) {
            case INTEGRITY:
                // Save the encrypted data under the given alias
     ...
     * @throws CryptoIOHelper.IntegrityCheckFailedException
     */
    public byte[] retrieve(Integrity integrity, Mode mode, String alias) throws CryptoIOHelper.NoKeyMaterialException, CryptoIOHelper.IntegrityCheckFailedException, IOException, GeneralSecurityException,
            CryptoIOHelper.DataNotAvailableException {
     ...
     * @throws CryptoIOHelper.IntegrityCheckFailedException
     */
    public byte[] retrieveWithPassword(Integrity integrity, Mode mode, String alias, char[] password) throws CryptoIOHelper.NoKeyMaterialException, CryptoIOHelper.IntegrityCheckFailedException, IOException, CryptoIOHelper.DataNotAvailableException,
     ...
     * @throws CryptoIOHelper.IntegrityCheckFailedException
     */
    public boolean changePassword(char[] oldPassword, char[] newPassword) throws CryptoIOHelper.IntegrityCheckFailedException, GeneralSecurityException, CryptoIOHelper.DataNotAvailableException {
     ...
     * @throws CryptoIOHelper.IntegrityCheckFailedException
     */
    public boolean changeFromAutoPassword(char[] newPassword) throws CryptoIOHelper.IntegrityCheckFailedException, GeneralSecurityException, CryptoIOHelper.DataNotAvailableException {
     ...
     * @throws CryptoIOHelper.IntegrityCheckFailedException
     */
    public boolean changeToAutoPassword(char[] oldPassword) throws CryptoIOHelper.IntegrityCheckFailedException, GeneralSecurityException, CryptoIOHelper.DataNotAvailableException {
        return changePasswordPrivate(oldPassword, getAutoPassword().toCharArray());
    }

    /**
     * Deletes either the SharedPref alias entry or the file saved under the alias.
     *
     * @param mode  The storage mode. Choose SecureAndroid.Mode.SHARED_PREFERENCES or FILE.
     ...
     * @throws CryptoIOHelper.IntegrityCheckFailedException
     */
    private boolean changePasswordPrivate(char[] oldPassword, char[] newPassword) throws CryptoIOHelper.IntegrityCheckFailedException, GeneralSecurityException, CryptoIOHelper.DataNotAvailableException {
        ...
        try {
            ...
            storePasswordAndIntermediateKeyCipherIV(intermediateAESCipherIV, intermediateMACCipherIv);
        ...
        try {
            ...
            storePasswordAndIntermediateKeyCipherIVWithoutMAC(intermediateAESCipherIV);
            // Load the stored keys to check if save was successful
     ...
     * @throws CryptoIOHelper.DataNotAvailableException
     */
    private byte[] encrypt(Integrity integrity, byte[] plaintext, char[] password) throws CryptoIOHelper.NoKeyMaterialException, CryptoIOHelper.IntegrityCheckFailedException, GeneralSecurityException, CryptoIOHelper.DataNotAvailableException {
     ...
     * @throws CryptoIOHelper.IntegrityCheckFailedException
     */
    private byte[] decrypt(Integrity integrity, byte[] ivAndCipherAndMAC, char[] password) throws CryptoIOHelper.NoKeyMaterialException, CryptoIOHelper.IntegrityCheckFailedException, GeneralSecurityException, CryptoIOHelper.DataNotAvailableException {
     ...
     * @throws CryptoIOHelper.DataNotAvailableException
     */
    private byte[] retrieve(Integrity integrity, Mode mode, String alias, char[] password) throws GeneralSecurityException, CryptoIOHelper.NoKeyMaterialException, CryptoIOHelper.IntegrityCheckFailedException,
     ...
     *
     * @param cipherIv The cipherIv object that holds the seperate ciphertext and iv arrays.
     * @param mac      The MAC corresponding to the cipherIv object.
     * @return The byte array in which the iv and the ciphertext are concatenated.
     */
     ...
     * @throws CryptoIOHelper.NoKeyMaterialException
     */
    private SecretKeys getKeyData(char[] password) throws CryptoIOHelper.NoKeyMaterialException, CryptoIOHelper.IntegrityCheckFailedException, CryptoIOHelper.DataNotAvailableException, GeneralSecurityException {
        try {
            // Load the salt values for generating the AES- and MAC-master-keys
            ...
            if (macCrypto.checkIntegrity(intermediateAESCipherIV.getCipher(), intermediateAESKeyMAC, macMasterKey) &&
                ...
                // Extract the raw key data for the AES- and MAC-intermediate-keys
     ...
     * @throws CryptoIOHelper.NoKeyMaterialException
     */
    private SecretKey getKeyDataWithoutMAC(char[] password) throws CryptoIOHelper.NoKeyMaterialException, CryptoIOHelper.IntegrityCheckFailedException, CryptoIOHelper.DataNotAvailableException, GeneralSecurityException {
     ...
     */
    private void storePasswordAndIntermediateKeyCipherIV(AESCrypto.CipherIV intermediateAESCipherIV,
     ...
     * @param intermediateAESCipherIV The encrypted intermediate aes key and the corresponding iv.
     */
    private void storePasswordAndIntermediateKeyCipherIVWithoutMAC(AESCrypto.CipherIV intermediateAESCipherIV) {
     ...
     *
     * @param mode              The storage mode. Choose SecureAndroid.Mode.SHARED_PREFERENCES or FILE.
     * @param ivAndCipherAndMAC The byte array containing the cipher, iv and MAC.
